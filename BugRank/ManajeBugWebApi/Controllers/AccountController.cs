...
using ManajeBugWebApi.Providers;
using ManajeBugWebApi.Results;
using MajeBugDomain;
            ...
            using (var tx = dbContext.Database.BeginTransaction()) {
                ...
                using (var tx2 = dataContext.Database.BeginTransaction()) {
                    ...
                    } else
                    {
                        try
                        {
                            var userApp = new User { Id = user.Id, name = user.Email, createdAt = DateTime.Now };
                            //var context = new MajeBug.Data.DataContext();
